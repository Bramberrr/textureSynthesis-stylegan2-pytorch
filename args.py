...
parser.add_argument("--e_reg_every", type=int, default=4, help="Not actually used in this project (just for consistent adam params init). Interval of the applying path length regularization")
